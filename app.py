...
# --- LISTA REAL DE PRIMERA DIVISIÓN (LIGA I 25/26) ---
# He eliminado a los de segunda y dejado solo los 16 oficiales
EQUIPOS_LIGA_I_OFICIAL = [
...
def get_matches():
    """Busca el historial solo para cálculos internos."""
    matches = []
...
@app.route('/api/teams')
def teams():
    """Devuelve solo los 16 equipos que definimos arriba."""
    return jsonify({'teams': [{'team': x} for x in sorted(EQUIPOS_LIGA_I_OFICIAL)]})
